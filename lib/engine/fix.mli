...
(** Substitutes an expression's own source text, parenthesised unless the expression is
    ...
    Prefer this over building {!Lintml_engine.Rule.Source} directly: omitting parentheses
    around a compound expression produces a fix that changes precedence, which is worse
