(** A source file indexed by line, for turning {!Lintml_engine.Loc.t} into byte offsets.
*)
...
val range : t -> Lintml_engine.Loc.t -> (int * int) option
...
val slice : t -> Lintml_engine.Loc.t -> string option
